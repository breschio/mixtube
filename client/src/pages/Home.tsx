...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background/95 flex flex-col relative">
      {/* Retro Grid Background */}
      <RetroGrid className="fixed inset-0" />

      {/* Main Content - Overlay on top of grid */}
        ...
        <main className="flex-1 container max-w-[1800px] mx-auto px-3 sm:px-4 md:px-6 py-4">
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
            ...
            <div className="w-full sm:w-[70%] space-y-4">
              <Card className="overflow-hidden border-none bg-background/80 backdrop-blur supports-[backdrop-filter]:bg-background/60">
                <MixedVideoPlayer
            ...
            <div className="w-full sm:w-[30%]">
              <Card className="h-full bg-background/80 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-none">
